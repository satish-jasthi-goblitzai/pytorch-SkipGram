...
def create_HP_corpous():
    data_dir = "/mnt/d/OneDrive - GoBlitzAI/OneDrive - Accretive Wiz@Work Consultants/Projects/pytorch-SkipGram-master/data"
    HP_CORPUS = ''
    for book in Path(data_dir).glob('*'):
        with open(book, 'r',  encoding="utf8", errors='ignore') as handle:
